                        ...
                        <div className='col-lg-6 px-3 my-3' key={index}>
                            <div className="apt-main-container d-flex">
                                <div className="apt-img-section align-items-start" >
                                    <Avatar className='apt-img' size='70' round name={`${appointment?.patient?.fName} ${appointment?.patient?.lName}`} src={appointment?.patient?.profileImg} />
                                </div>
                                <div className="apt-info ml-5">
                                    <h4 className='text-blue font-weight-bold'> {`${appointment?.patient?.fName} ${appointment?.patient?.lName}`}</h4>
                                    ...
                                    <p className='my-2'>
                                        ...
                                        <span>+91 {appointment?.patient?.mobileNo}</span>
                                    </p>
                                    <p className='my-2'>
                                        <span className='apt-info-head'>Appointment Date:</span>
                                        <span> {moment(appointment?.appointmentDate).format('LL')}</span>
                                    </p>
