...
export default function GeneratePrescription(props) {
    ...
    const onchangeHandler = (event) => {
        setEditMedicine(current => ({ ...current, [event.target.name]: event.target.value }))
    }
    ...
    const PrescriptionSchema = Yup.object().shape({
        ...
        nextVisitDate: Yup.date()
            .min(moment(new Date()).format("YYYY-MM-DD"), "Date must be later than today's date")
    });
                    ...
                    <div className="row px-3 my-md-1">
                        <div className="col-md-3">
                            <TextField
                                ...
                                error={formik.touched.nextVisitDate && Boolean(formik.errors.nextVisitDate)}
                                onChange={formik.handleChange}
                            />
                            <div className='add-doctor-error-message text-right mr-1'>
                                {(formik.touched.nextVisitDate) ? (formik.errors.nextVisitDate) : null}
                            </div>
                        </div>
                    </div>
            ...
            <div className="add-prescription-container px-4">
                <div className="add-prescription-card pb-4">
                    ...
                    <div className="row px-3 my-md-1">
                        ...
                        <div className="col-12 col-lg-4 my-3 my-md-0 patient-info">
                            <p>Name: <span className="text-blue ml-2">{`${patient?.fName} ${patient?.lName}`}</span></p>
                        </div>
                        <div className="col-12 col-lg-4 my-3 my-md-0 patient-info">
                            <p>Age: <span className="text-blue ml-2">{patient?.age}</span></p>
                        </div>
                        <div className="col-12 col-lg-4 my-3 my-md-0 patient-info">
                            <p>Contact: <span className="text-blue ml-2">+91 {patient?.mobileNo}</span></p>
                        </div>
                        <div className="col-12 my-3 my-md-0 patient-info">
                            <p>Address: <span className="text-blue ml-2">{patient?.address}</span></p>
                        </div>
                    </div>

                    <div className="px-3 my-md-2">
                                                        ...
                                                        <>
                                                            {
                                                                medicine?.id === editMedicine?.id ? (
                                                                    <tr key={index} className="align-items-center edit-medicine-container">
                                                                        <td className="pb-2">
                                                                            <TextField
                                                                                autoComplete="off"
                                                                                type="text"
                                                                    ...
                                                                    <tr key={index} className="align-items-center">
                                                                        ...
                                                                        <td className="py-2">
                                                                            <IconButton
                                                                                ...
                                                                                size="small"
                                                                                onClick={() => { editMedicineHandler(medicine) }}
                                                                            >
